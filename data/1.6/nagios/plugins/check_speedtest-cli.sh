...
echo $nagcode > /var/log/nems/speedtest.log # State of service
echo $ping >> /var/log/nems/speedtest.log # Ping time
echo $pingUOM >> /var/log/nems/speedtest.log # Ping measurement
echo $download >> /var/log/nems/speedtest.log # Download speed
echo $downloadUOM  >> /var/log/nems/speedtest.log # Download speed measurement
echo $upload >> /var/log/nems/speedtest.log # Upload speed
echo $uploadUOM >> /var/log/nems/speedtest.log # Upload speed measurement
