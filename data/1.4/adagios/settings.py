# NEVER EDIT OR REMOVE THESE LINES! Doing so would cause the file to revert to earlier NEMS Update state!
# To increase version, add another NEMS increment number, CSV.
# NEMS00000
...
# Disabled objectbrowser (config) in NEMS
